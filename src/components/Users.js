        ...
        <div style={{ backgroundColor:'#F2F2F7' }}>
            ...
            <Container>
              <Box className={classes.root}>
                ...
                <Typography variant="h6" gutterBottom display="block" className={classes.titleUserName}>
                  @{username}
                </Typography>

                <Box display="inline">
                  <MailIcon className={classes.titleIcon}/>
                  <Typography variant="subtitle2" gutterBottom display="inline" className={classes.titleUserDetails}>
                    {website}
                  </Typography>
                </Box>
              ...
              <Container><Divider style={{margin:'0em 2.5em'}}/></Container>
